...
bot('answerInlineQuery',[
    ...
    'results'=>json_encode([[
        ...
        'reply_markup'=>[
            'inline_keyboard'=>[
                [['text'=>'Xabarni oqish','callback_data'=>$query]]
            ]]]])]);
...
if ($msg_text == '/start')
{
    bot('sendMessage',[
        'chat_id'=>$chat_id,
        'text'=>"Salom, men matnni yashridigan botman. \nAgar quyidagi tugmani bosing va matnning matnini o'zgartiring. ",
        'parse_mode'=>'HTML',
        'reply_markup'=>json_encode(['inline_keyboard'=>[
            [['text'=>'Onlayn rejimga oting','switch_inline_query'=>'Matn']]
